...
const InvestModal = ({ project, balance, onClose, onSuccess }) => {
    ...
    const handleInvest = async () => {
        ...
        if (amountNum > remaining) {
             alert(
                `Investment exceeds remaining target. Remaining: ${remaining} DH`,
            );
            return;
        }
        if (amountNum > maxPerInvestor) {
             alert(
                `Maximum investment per investor is ${maxPerInvestor} DH`,
            );
            return;
        }
        setIsLoading(true);
        try {
            ...
            await dispatch(fetchProjectById(project._id));
             ...
             alert(
                `Successfully invested ${amountNum} DH in ${project.title}`,
            );
            onClose();
                ...
                <div className="modal-container">
                    ...
                    <div className="modal-body">
                        ...
                        <div className="ownership-card">
                            ...
                            <div>
                                <strong>
                                    You will own {ownershipPercent}% of this
                                    project
                                </strong>
                                <p>
                                    Based on your investment amount relative to
                                    the target capital
                                </p>
                            </div>
                        </div>
                        ...
                        {amount && parseFloat(amount) > 0 && (
                            <div className="summary-card">
                                ...
                                <div className="summary-row">
                                    ...
                                    <strong>
                                        {parseFloat(amount).toLocaleString()} DH
                                    </strong>
                                </div>
                                <div className="summary-row">
